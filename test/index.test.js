...
describe('Xget Core Functionality', () => {
  describe('Basic Request Handling', () => {
    it('should redirect root path to homepage', async () => {
      ...
      expect(response.headers.get('Location')).toBe('https://live.bilibili.com/299/');
    });
    ...
    it('should redirect platform prefix without path to homepage', async () => {
      ...
      expect(response1.headers.get('Location')).toBe('https://live.bilibili.com/299/');

      // Test with /gh/ (with trailing slash)
      const response2 = await SELF.fetch('https://example.com/gh/', { redirect: 'manual' });
      expect(response2.status).toBe(302);
      expect(response2.headers.get('Location')).toBe('https://live.bilibili.com/299/');
      ...
      expect(response3.headers.get('Location')).toBe('https://live.bilibili.com/299/');
    });
